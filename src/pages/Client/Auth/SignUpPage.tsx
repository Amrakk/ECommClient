import { Card, CardContent, Typography, Box, FormControl, FormLabel, TextField, Divider, Button } from "@mui/material";
                ...
                >
                    <CardContent sx={{ display: "flex", gap: 1, flexDirection: "column", m: 2 }}>
                        ...
                        >
                            ...
                            <Button sx={{ borderRadius: 2 }} type="submit" variant="contained">
                                Register
                            </Button>
                        </Box>
                        <Box
