...
const CheckoutPage = () => {
    ...
    const {
        ...
        data: dataShipping,
    } = useGetShippingFeeQuery(currentAddress);
                    ...
                    <Grid size={{ lg: 7, xs: 12 }}>
                        <Paper elevation={2} sx={{ p: 4, borderRadius: 3 }}>
                            ...
                            <Grid
                                ...
                                spacing={2}
                                display="flex"
                                justifyContent={{ lg: "flex-start", sm: "flex-start", xs: "center" }}
                            >
                                {user!.addresses.map((address, index) => (
                                    <AddressCard
                                        key={index}
                                        value={index.toString()}
                                        isSelected={selectedAddress.includes(index.toString())}
                                        address={address}
                                        onEdit={(value) => {
                                            ...
                                            <Box>
                                                <Typography variant="subtitle1" fontWeight="500">
                                                    ...
                                                    {!isLoadingShippingFee
                                                        ? convertToVietnameseDong(shippingFee)
                                                        : "Loading..."}
                                                </Typography>
