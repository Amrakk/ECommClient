...
const CartPage = () => {
    ...
    const handleChangeVariant = (productId: string, variantIdCurrent: string, variantIdChange: string) => {
        setLocalCart((prev) => {
            ...
            const sameItems = newCart.items.filter(
                (i) => i.product._id === productId && i.variantId === variantIdChange
            );
            if (sameItems.length > 1) {
                const quantity = sameItems.reduce((acc, cur) => acc + cur.quantity, 0);
                sameItems.forEach((i) => {
                    const index = newCart.items.findIndex(
                        (item) => item.product._id === i.product._id && item.variantId === i.variantId
                    );
        ...
        <Grow in={checkedGrow} timeout={800}>
            <Box sx={{ m: { xs: 1.5, md: 5 }, mt: { xs: 5, md: 10 } }}>
                ...
                <Snackbar
                    ...
                    action={
                        <Button
                            onClick={() => navigate(CustomerPaths.home.User)}
                            sx={{ color: ColorSecondaryBlackOverlay(1) }}
                        >
                            Add address
                        </Button>
                    }
                            ...
                            cart.items.length == 0 ? (
                                ...
                                >
                                    <Box
                                        ...
                                        alt="empty cart"
                                        sx={{
                                            width: { lg: "30%", sm: "70%", md: "50%", xs: "100%" },
                                            height: "auto",
                                            opacity: 0.5,
                                        }}
                                    />
                                        ...
                                        >
                                            ...
                                            <Grid size={{ xs: 3, md: 1.5 }}>
                                                <Box
                                                    ...
                                                    onClick={() =>
                                                        navigate(
                                                            `${CustomerPaths.home.Product.Detail}/${item.product._id}`
                                                        )
                                                    }
                                            ...
                                            <Grid size={{ xs: 4, md: 2 }}>
                                                <Box display="flex" alignItems="center">
                                                    <IconButton
                                                        onClick={() =>
                                                            decreaseQuantity(item.product._id, item.variantId)
                                                        }
                                                        size="small"
                                                        color="primary"
                                                    >
                                                    ...
                                                    <IconButton
                                                        onClick={() =>
                                                            increaseQuantity(item.product._id, item.variantId)
                                                        }
                                                        size="small"
                                                        color="primary"
                                                    >
                                            ...
                                            <Grid size={2}>
                                                <Typography
                                                    sx={{
                                                        fontSize: { md: FONT_SIZE.h6, xs: FONT_SIZE.body2 },
                                                        fontWeight: "medium",
                                                    }}
                                                    color="primary"
                                                >
                        ...
                        <Grid size={12}>
                            ...
                            >
                                <Typography variant="body2" color="textSecondary">
                                    Total:{" "}
                                    <span
                                        style={{ color: ColorPrimary(1), fontSize: FONT_SIZE.h6, fontWeight: "bold" }}
                                    >
                                        {convertToVietnameseDong(totalPrice)}
                                    </span>
                                </Typography>
                            </Box>
                        </Grid>
