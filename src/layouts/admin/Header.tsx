...
export default function Header() {
    ...
    return (
        <header className="border-b-2 flex justify-between items-center bg-gray-100 p-2 pr-6">
            <div id="avatarBtn" className="p-1 ml-auto">
                ...
                {open && (
                    <div className="absolute right-6 top-16 min-w-44 flex flex-col gap-1 px-4 py-2 overflow-hidden rounded-md z-10 bg-white shadow-lg fade-in max-w-[90vw] select-none">
